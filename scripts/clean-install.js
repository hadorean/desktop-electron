...
try {
  ...
  // Build Electron
  try {
    execSync('cd node_modules/.pnpm/electron@*/node_modules/electron && npm run postinstall', { stdio: 'inherit', shell: true });
  ...
  try {
    execSync('cd node_modules/.pnpm/electron-as-wallpaper@*/node_modules/electron-as-wallpaper && npm run install', { stdio: 'inherit', shell: true });
